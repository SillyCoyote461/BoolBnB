...
<body style="">
    ...
    <form class="d-flex flex-column w-50 m-auto" method="POST" action="{{ route('admin.apartments.update', $apartment->id) }}" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="number" min="1" max="50" class="form-control" name="rooms" value="{{$apartment->rooms}}" required>
            @error('rooms')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="number" min="1" max="50" class="form-control" name="beds" value="{{$apartment->beds}}" required>
            @error('beds')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="number" min="1" max="50" class="form-control" name="baths" value="{{$apartment->baths}}" required>
            @error('bathrooms')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="number" min="1" max="1000" class="form-control" name="meters" value="{{$apartment->meters}}" required>
            @error('mq')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" class="form-control" name="address" id="address" required value="{{$apartment->address}}" readonly="readonly">
            @error('address')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="number" min="1" class="form-control" name="price" value="{{$apartment->price}}" required>
            @error('price')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
